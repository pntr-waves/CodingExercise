...
public class DataTestingBuilder {
    public static List<Book> getBookList() {
        ...
        bookList.add(new Book("Cygnus atratus", "White Poplar", 1996));
        bookList.add(new Book("Nyctereutes procyonoides", "oseltamivir phosphate", 2008));
        bookList.add(new Book("Megaderma spasma", "OXYGEN", 2006));
        ...
        bookList.add(new Book("Podargus strigoides", "Leucovorin Calcium", 2012));
        bookList.add(new Book("Felis silvestris lybica", "Hops", 1998));
        bookList.add(new Book("Lamprotornis superbus", "Octinoxate and Oxybenzone", 2002));
        bookList.add(new Book("Sula dactylatra", "Carboxymethylcellulose sodium", 1995));
        ...
        bookList.add(new Book("Streptopelia senegalensis", "TRAMADOL HYDROCHLORIDE", 2009));
        bookList.add(new Book("Pelecanus conspicillatus", "Octinoxate", 1992));
        bookList.add(new Book("Vanellus armatus", "Labetalol hydrochloride", 2011));
        bookList.add(new Book("Pteropus rufus", "Acetaminophen and Phenylephrine Hydrochloride", 1991));
        bookList.add(new Book("Hyaena hyaena", "Alcohol", 2008));
        bookList.add(new Book("Haematopus ater", "factor ix complex", 2010));
        bookList.add(new Book("Papio cynocephalus", "TOPICAL STARCH", 2002));
        bookList.add(new Book("Myrmecophaga tridactyla", "hydrocortisone acetate and pramoxine hydrochloride", 1995));
        ...
        bookList.add(new Book("Oryx gazella", "Salicylic Acid", 2006));
        bookList.add(new Book("Ammospermophilus nelsoni", "Pyrithione Zinc", 2003));
        bookList.add(new Book("Bassariscus astutus", "Carvedilol", 1988));
        ...
        bookList.add(new Book("Francolinus coqui", "Acetaminophen", 1989));
        bookList.add(new Book("Tragelaphus strepsiceros", "Camphor", 2007));
        bookList.add(new Book("Iguana iguana", "ETHYL ALCOHOL", 2007));
        bookList.add(new Book("Phalacrocorax carbo", "Felis Domesticus Hair", 2002));
        bookList.add(new Book("Anser anser", "SODIUM FLUORIDE", 1987));
        bookList.add(new Book("Felis serval", "Rosuvastatin calcium", 2007));
        bookList.add(new Book("Recurvirostra avosetta", "Grama Grass", 2007));
        bookList.add(new Book("Dusicyon thous", "Benzalkonium chloride", 2002));
        bookList.add(new Book("Larus dominicanus", "Dextromethorphan HBr. and Guaifenesin", 2007));
        bookList.add(new Book("Conolophus subcristatus", "Octinoxate and Oxybenzone", 1993));
        bookList.add(new Book("Choloepus hoffmani", "Camphor", 1995));
        bookList.add(new Book("Bassariscus astutus", "Aluminum Chlorohydrate", 2000));
        bookList.add(new Book("Eudyptula minor", "amlodipine besylate and benazepril hydrochloride", 2000));
        bookList.add(new Book("unavailable", "cefuroxime", 2006));
        bookList.add(new Book("Spermophilus parryii", "GUAIFENESIN and Dextromethorphan Hydrobromide", 1992));
        bookList.add(new Book("Anas platyrhynchos", "Brome Grass", 2000));
        bookList.add(new Book("Macaca mulatta", "Tacrolimus", 2000));
        bookList.add(new Book("Tamiasciurus hudsonicus", "Fluoxetine Hydrochloride", 2000));
        bookList.add(new Book("Pytilia melba", "Eucalyptol", 1995));
