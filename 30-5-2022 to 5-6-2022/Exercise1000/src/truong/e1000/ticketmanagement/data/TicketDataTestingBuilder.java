...
public class TicketDataTestingBuilder {
	public static List<Ticket> getTicketList () {
		...
		ticketList.add(new Ticket("E. FOUGERA & CO., A division of Fougera Pharmaceuticals Inc.", 52.87, "11:49", "17/08/2021"));
		...
		ticketList.add(new Ticket("Johnson & Johnson Consumer Products Company, Division of Johnson & Johnson Consumer Companies, Inc.", 56.41, "18:13", "13/04/2022"));
		...
		ticketList.add(new Ticket("Global Pharmaceuticals, Division of Impax Laboratories Inc.", 40.88, "11:09", "30/07/2021"));
